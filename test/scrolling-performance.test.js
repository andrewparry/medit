...
describe('Scrolling Performance Optimizations', () => {
    ...
    describe('Scroll Performance Classes', () => {
        test('should add smooth scroll classes to editor and preview elements', () => {
            ...
            expect(editorCore.editorElement.classList.add).toHaveBeenCalledWith(
                'smooth-scroll-enabled'
            );
            expect(editorCore.previewElement.classList.add).toHaveBeenCalledWith(
                'smooth-scroll-enabled'
            );
        });
        ...
        test('should handle missing elements gracefully', () => {
            ...
            expect(console.warn).toHaveBeenCalledWith(
                '⚠ Cannot optimize scrolling: elements not found'
            );
        });
        ...
        test('should remove large document classes for small content', () => {
            ...
            expect(editorCore.editorElement.classList.remove).toHaveBeenCalledWith(
                'large-document'
            );
            expect(editorCore.previewElement.classList.remove).toHaveBeenCalledWith(
                'large-document'
            );
        });
    ...
    describe('Performance Monitoring', () => {
        ...
        test('should handle performance degradation gracefully', () => {
            ...
            global.performance.now.mockReturnValueOnce(0).mockReturnValueOnce(50); // 50ms frame time (poor performance)
